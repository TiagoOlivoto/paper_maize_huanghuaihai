...
env_wider <-  
  env_data |> 
  select(env, year, daysFromStart, T2M:RTA) |> 
...
export(env_wider, "data/env_wider.Rdata")
```
...
ggsave("figs/fig3_pca.png", width = 7, height = 7)
...
arrange_ggplot(bip1, bip2, 
               tag_levels = "A")
ggsave("figs/fig4_pca.png", width = 14, height = 7)
...
arrange_ggplot(p1, p2,
               ncol = 1,
               tag_levels = "A")
ggsave("figs/fig5_typology_vpd.png", width = 10, height = 5)
...
ggplot(vcomp, aes(name, variance, fill = group)) +
  ...
  labs(x = "Traits",
       ...
       fill = "Source")
ggsave("figs/fig6_vcomp.png", width = 6, height = 5)
...
ggsave("figs/fig7_radar.png", width = 12, height = 4)
...
ggsave("figs/fig8_veen.png", width = 6, height = 5)
```
...
ggplot(ds_stab, aes(name, sd_perc)) +
  ...
  theme(legend.position = "bottom",
        ...
        panel.grid.minor = element_blank()) +
  scale_fill_manual(values = ggthemes::stata_pal()(4)[c(2, 3)])
ggsave("figs/fig10_sd_stab.png", width = 14, height = 6)
...
ggsave("figs/fig11_gge.png", width = 10, height = 5)
```
