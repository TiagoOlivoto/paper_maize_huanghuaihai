...
# Figure S12  {-}
```{r echo=FALSE,fig.cap="Quantiles for minimum air temperature (A) and maximum air temperature (B) observed in the studied mega-environments across distinct crop stages and cultivation years.", fig.width=13, fig.height=8}
...
# Figure S13  {-}
```{r echo=FALSE, fig.width=10, fig.height=6, echo=FALSE, fig.cap="Relationhips between rainfall precipitation and grain yield"}
df_gymey <- 
  df_traits |> 
  mean_by(YEAR, LOC) |> 
  select(YEAR, LOC, GY)
