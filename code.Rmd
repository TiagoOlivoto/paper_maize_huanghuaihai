...
### vpd {.panelset}
```{r echo=FALSE, fig.cap="Quantiles for vapor pressure deficit observed in the studied environments (a) and mega-environments (b) across distinct crop stages.", fig.width=13, fig.height=7}
