...
print_table(loadings, caption = "Factorial loadings after varimax rotation, and communalities obtained in the factor analysis within each mega-environments (ME1, ME2, ME3, and ME4).")
